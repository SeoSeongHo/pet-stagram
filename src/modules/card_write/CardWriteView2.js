...
class CardWriteView2 extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="di1">
        <Button onClick={this.openModal} className="btt1">EDIT</Button>
        <Modal
...
CardWriteView2.contextTypes = {
  router: React.PropTypes.object.isRequired,
  location: React.PropTypes.object,
  match: React.PropTypes.object
};
export default CardWriteView2
{/* <ImageUploader
      withIcon={true}
